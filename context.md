# Contexto del Desarrollador y Filosofía de Arquitectura
...
| Frontend build | Vite | última estable |
...
Al operar en VPS propio (sin la red de seguridad de un cloud managed), la observabilidad es responsabilidad nuestra:
